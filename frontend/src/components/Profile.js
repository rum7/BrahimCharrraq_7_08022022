...
const Dashboard = () => {
  ...
  return(
    <>
      ...
      <h2 className="title is-6 mb-2 px-2 pt-1 pb-2 has-background-link has-text-light box">Bienvenu {prenom} {nom}</h2>
        <table className="table is-striped is-fullwidth mb-6">
          <tbody>
            ...
            <tr>
              <td>Image</td>
              {/* <td>{image}</td> */}
              <td><p className="image is-128x128"><img src={'images/' + image} /></p></td>
            </tr>
          </tbody>
        </table>
        ...
        <table className="table is-striped is-fullwidth mb-6">
            ...
            <tbody>
              {users.map((user, index) => (
                <tr key={user.id}>
                  <td><p className="image is-96x96"><img src={'images/' + user.image} /></p></td>
                  {/* <td>{user.image}</td> */}
                  <td>{user.id}</td>
                  <td>{user.prenom}</td>
                  <td>{user.nom}</td>
